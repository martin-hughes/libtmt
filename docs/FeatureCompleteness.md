...
| cub1         | \E[D                 | :white_check_mark:   | Move cursor 1 place to the left                    |                                                                                                                     |
| cud          | \E[%p1%dB            | :white_check_mark:   | Move cursor P1 places down                         |                                                                                                                     |
| cud1         | \E[B                 | :white_check_mark:   | Move cursor 1 place down                           |                                                                                                                     |
| cuf          | \E[%p1%dC            | :white_check_mark:   | Move cursor P1 places right                        |                                                                                                                     |
| cuf1         | \E[C                 | :white_check_mark:   | Move cursor 1 place right                          |                                                                                                                     |
...
| cuu1         | \E[A                 | :white_check_mark:   | Move cursor 1 place up                             |                                                                                                                     |
...
| dl           | \E[%p1%dM            | :white_check_mark:   | Delete P1 lines                                    |                                                                                                                     |
| dl1          | \E[M                 | :white_check_mark:   | Delete 1 line                                      |                                                                                                                     |
| ech          | \E[%p1%dX            | :white_check_mark:   | Erase P1 characters                                |                                                                                                                     |
| ed           | \E[J                 | :white_check_mark:   | Clear to end of screen                             |                                                                                                                     |
| el           | \E[K                 | :white_check_mark:   | Clear to end of line                               | Note 2                                                                                                              |
| el1          | \E[1K                | :white_check_mark:   | Clear to beginning of line                         | Note 2                                                                                                              |
| home         | \E[H                 | :white_check_mark:   | Move cursor to home                                |                                                                                                                     |
...
| ich          | \E[%p1%d@            | :white_check_mark:   | Insert blank space P1 times                        |                                                                                                                     |
| il           | \E[%p1%dL            | :white_check_mark:   | Insert P1 lines                                    |                                                                                                                     |
| il1          | \E[L                 | :white_check_mark:   | Insert 1 line                                      |                                                                                                                     |
...
| nel          | \r\E[S               | :white_check_mark:   | Newline                                            | Tested as individual parts - `\r` and `E[S`                                                                         |
| op           | \E[39;49m            | :white_check_mark:   | Set default pair to original value                 | Note 1                                                                                                              |
| rep          | %p1%c\E[%p2%{1}%-%db | :white_check_mark:   | Repeat char P1 a total of P2 times                 |                                                                                                                     |
