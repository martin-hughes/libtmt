...
|--------------|----------------------|----------------------|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| am           | n/a                  | :white_check_mark:   | Automatic margin support                           | Note 11                                                                                                             |
| mc5i         | n/a                  | :bomb:               | Printer output will not display on screen          | Note 9                                                                                                              |
...
| cols         | 80                   | :information_source: | Number of columns in the terminal                  | Note 8                                                                                                              |
| it           | 8                    | :x:                  | Tabs initially every 'n' spaces                    |                                                                                                                     |
| lines        | 24                   | :information_source: | Number of lines in the terminal                    | Note 8                                                                                                              |
| ncv          | 3                    | :ok:                 | No colour video                                    | Note 6                                                                                                              |
...
| acsc         | Note 7               | :x:                  | Supported alternate character set                  | Note 7                                                                                                              |
...
| sgr          | Note 5               | :white_check_mark:   | Set attributes                                     | Notes 1, 5                                                                                                          |
...
| u7 / dsr(6)  | \E[6n                | :white_check_mark:   | User string 7                                      | Note 10                                                                                                             |
...
5. The full keycode string for `sgr` is `\E[0;10%?%p1%t;7%;%?%p2%t;4%;%?%p3%t;7%;%?%p4%t;5%;%?%p6%t;1%;%?%p7%t;8%;%?%p9%t;11%;m,`

6. This says that "standout" and "underline" can't be used with colour video modes. libtmt doesn't particularly care if
   you do use them.

7. terminfo specifies `+\020\,\021-\030.^Y0\333`\004a\261f\370g\361h\260j\331k\277l\332m\300n\305o~p\304q\304r\304s_t\303u\264v\301w\302x\263y\363z\362{\343\330}\234~\376`

8. libtmt allows almost any number of lines or columns in a terminal. If you're implementing a full terminal and want
   it to be "ansi", then simply create a terminal matching these values.

9. All printing modes and related features are ignored by libtmt, so relying on `mc5i` will not work - the "printed"
